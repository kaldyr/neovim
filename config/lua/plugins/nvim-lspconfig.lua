...
local on_attach = function(_, bufnr)
    ...
    vim.keymap.set('n', '<leader>ds', vim.lsp.buf.document_symbols, { buffer = bufnr, desc = 'Document Symbols' })
    vim.keymap.set('n', '<leader>wa', vim.lsp.buf.add_workspace, { buffer = bufnr, desc = 'Workspace Add Folder' })
    vim.keymap.set('n', '<leader>wl', vim.lsp.buf.list_workspace, { buffer = bufnr, desc = 'Workspace List Folders' })
    vim.keymap.set('n', '<leader>wr', vim.lsp.buf.remove_workspace, { buffer = bufnr, desc = 'Workspace Remove Folder' })
    vim.keymap.set('n', '<leader>ws', vim.lsp.buf.workspace_symbols, { buffer = bufnr, desc = 'Workspace Symbols' })
end
